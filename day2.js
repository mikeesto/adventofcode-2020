...
// input.forEach((item) => {
//   let min = item.split(" ")[0].split("-")[0];
//   let max = item.split(" ")[0].split("-")[1];
//   let char = item.split(" ")[1].substr(0, 1);
//   let password = item.split(" ")[2];
//   let y = password.split(char).length - 1;
...
input.forEach((item) => {
  ...
  let max = item.split(" ")[0].split("-")[1];
  let char = item.split(" ")[1].substr(0, 1);
  let password = item.split(" ")[2].split("");
